...
- [transitdata-alert-processor](https://github.com/HSLdevcom/transitdata-alert-processor) reads OMM database and generates internal service alert messages
- [transitdata-omm-alert-source](https://github.com/HSLdevcom/transitdata-omm-alert-source) reads internal service alert messages and generates GTFS-RT Service alerts
